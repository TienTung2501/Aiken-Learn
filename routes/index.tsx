...
export const handler: Handlers<Data>={
  GET(_req,ctx){
    const validators=readValidators();// đọc dữ liệu lưu và validator

    return ctx.render({validators}); // nếu người dùng sử dụng phương thức GET thì sẽ gửi dữ liệu về người dùng 
  }
}
